...
# select branch 
SRCBRANCH = "dev/5.10.30-rt_dhsom"
...
COMPATIBLE_MACHINE = "(dh-stm32mp1-dhcom-common-pdk2-rt|dh-stm32mp1-dhcor-avenger96|dh-stm32mp1-dhcom-drc02|dh-stm32mp1-dhcom-picoitx)"
